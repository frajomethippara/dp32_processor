...
HD_PWD='H:/Projects/FPGA/Basys3/dp32_processor/dp32_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dp32_pkg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dp32_pkg.tcl
