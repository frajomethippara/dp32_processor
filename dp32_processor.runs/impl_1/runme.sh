...
HD_PWD='H:/Projects/FPGA/Basys3/dp32_processor/dp32_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dp32_pkg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dp32_pkg.tcl -notrace
