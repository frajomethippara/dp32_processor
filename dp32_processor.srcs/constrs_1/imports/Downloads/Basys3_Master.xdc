...
set_property PACKAGE_PIN W5 [get_ports clk]							
 ...
 set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets inc_dut_cyc_IBUF]
 
# Switches
set_property PACKAGE_PIN V17 [get_ports {dut_cyc[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc[0]}]
set_property PACKAGE_PIN V16 [get_ports {dut_cyc[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc[1]}]
set_property PACKAGE_PIN W16 [get_ports {dut_cyc[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc[2]}]
#set_property PACKAGE_PIN W17 [get_ports {dut_cyc[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {dut_cyc[3]}]
